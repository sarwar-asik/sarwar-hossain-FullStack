...
const ProfileBanner = () => {
  ...
  return (
    <div
      className="block lg:flex items-center justify-between  banner lg:mt-[6rem]   pl-6  text-text1 pt-6 rounded-lg lg:rounded-tl-[36%]"
      style={{ backgroundImage: `url(${bgImage})` }}
    >
      <section className=" sm:w-full pt-6  pl-1" data-aos="fade-right">
      ...
      <section className="w-full mx-auto bg-red-40 lg:-mt-[7.6rem]  " data-aos="fade-left">
        <img
          src={profile}
